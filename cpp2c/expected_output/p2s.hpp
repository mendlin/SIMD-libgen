...
#define p2s_ideal(p0,p1,p2,p3,p4,p5,p6,p7,s0,s1,s2,s3,s4,s5,s6,s7)  \
  do { \
	...
	bit01_r0= esimd_mergeh_1(p0,p1) ; \
	bit01_r1= esimd_mergel_1(p0,p1) ; \
	bit23_r0= esimd_mergeh_1(p2,p3) ; \
	bit23_r1= esimd_mergel_1(p2,p3) ; \
	bit45_r0= esimd_mergeh_1(p4,p5) ; \
	bit45_r1= esimd_mergel_1(p4,p5) ; \
	bit67_r0= esimd_mergeh_1(p6,p7) ; \
	bit67_r1= esimd_mergel_1(p6,p7) ; \
	bit0123_r0= esimd_mergeh_2(bit01_r0,bit23_r0) ; \
	bit0123_r1= esimd_mergel_2(bit01_r0,bit23_r0) ; \
	bit0123_r2= esimd_mergeh_2(bit01_r1,bit23_r1) ; \
	bit0123_r3= esimd_mergel_2(bit01_r1,bit23_r1) ; \
	bit4567_r0= esimd_mergeh_2(bit45_r0,bit67_r0) ; \
	bit4567_r1= esimd_mergel_2(bit45_r0,bit67_r0) ; \
	bit4567_r2= esimd_mergeh_2(bit45_r1,bit67_r1) ; \
	bit4567_r3= esimd_mergel_2(bit45_r1,bit67_r1) ; \
	s0= esimd_mergeh_4(bit0123_r0,bit4567_r0) ; \
	s1= esimd_mergel_4(bit0123_r0,bit4567_r0) ; \
	s2= esimd_mergeh_4(bit0123_r1,bit4567_r1) ; \
	s3= esimd_mergel_4(bit0123_r1,bit4567_r1) ; \
	s4= esimd_mergeh_4(bit0123_r2,bit4567_r2) ; \
	s5= esimd_mergel_4(bit0123_r2,bit4567_r2) ; \
	s6= esimd_mergeh_4(bit0123_r3,bit4567_r3) ; \
	s7= esimd_mergel_4(bit0123_r3,bit4567_r3) ; \
  } while(0) 
...
#define p2s_step(p0,p1,hi_mask,shift,s0,s1)  \
  do { \
	BitBlock t0,t1; \
	t0= simd_ifh_1(hi_mask,p0,simd_srli_16(shift, p1)) ; \
	t1= simd_ifh_1(hi_mask,simd_slli_16(shift, p0),p1) ; \
	s0= esimd_mergeh_8(t0,t1) ; \
	s1= esimd_mergel_8(t0,t1) ; \
  } while(0)
